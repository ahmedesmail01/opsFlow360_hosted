...
declare
  ...
  l_apex_username constant varchar2(255 char) :=
    'AHMEDESMAILOFFICIAL01@GMAIL.COM';

  -- EDIT BEFORE RUNNING: business display name, not a password or secret.
  l_display_name constant varchar2(200 char) :=
    'Ahmed Esmail';

  -- EDIT BEFORE RUNNING: email used for this business identity.
  l_email constant varchar2(255 char) :=
    'ahmedesmailofficial01@gmail.com';
...
begin
  ...
  dbms_output.put_line(
    'P08 bootstrap mapping created for ' ||
    upper(trim(l_apex_username)) || '.'
  );
end;
/
